...
router.post('/upload-image-from-url', authorize('admin', 'head_of_lab', 'lab_assistant'), uploadImageFromUrl);
...
// Admin and Head of Lab can publish/unpublish equipment
router.patch('/:id/publish', authorize('admin', 'head_of_lab'), togglePublish);

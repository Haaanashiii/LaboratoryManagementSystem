...
exports.borrowRequestValidation = [
  ...
  body('lecturer_id').optional({ checkFalsy: true }).isMongoId().withMessage('Valid lecturer ID is required'),
  body('lecturer_email').optional({ checkFalsy: true }).isEmail().withMessage('Valid lecturer email is required')
];

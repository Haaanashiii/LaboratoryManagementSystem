...
const DEFAULT_SIDEBAR_ITEMS = [
  ...
  { id: 'pendingApprovals', href: '/lecturer-approvals' },
  { id: 'approvalHistory',  href: '/lecturer-approval-history' },
  { id: 'settings',         href: '/lecturer-settings' },
];
  ...
  return (
    <div className="eq-admin" style={{ padding: '24px 28px', minHeight: '100%' }}>
      ...
      <div className="a-titlestrip" style={{ padding: '12px 22px' }}>
        <div>
          <div className="a-eyebrow">{t('lecturerSettingsEyebrow')}</div>
          <h1>{t('settings')}</h1>

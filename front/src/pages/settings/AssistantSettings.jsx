...
// ─── Default sidebar items (must match sidebar.jsx menuConfig.lab_assistant) ──
              ...
              <div className="rounded-xl overflow-hidden border border-slate-200 bg-white shadow-sm">
                ...
                <div className="border-t border-slate-100 bg-slate-50 px-3 py-2 flex items-center gap-2">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] font-semibold text-slate-700 truncate">{user?.name || 'Lab Assistant'}</p>
                    <p className="text-[9px] text-slate-400">Lab Assistant</p>
                  </div>
                </div>
              </div>

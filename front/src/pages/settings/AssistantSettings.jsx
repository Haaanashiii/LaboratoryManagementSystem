...
import {
  ...
  CheckSquare, History, ClipboardList,
} from 'lucide-react';
...
const DEFAULT_SIDEBAR_ITEMS = [
  ...
  { id: 'settings',      label: 'Settings',       href: '/assistant-settings' },
];

const SIDEBAR_KEY = 'lab_assistant_sidebar_order';
...
export default function AssistantSettings() {
  ...
  const saveSidebar = () => {
    ...
    window.dispatchEvent(new CustomEvent('lab_assistant:sidebar-reordered', { detail: items }));
  ...
  const resetSidebar = () => {
    ...
    window.dispatchEvent(new CustomEvent('lab_assistant:sidebar-reordered', { detail: DEFAULT_SIDEBAR_ITEMS }));
  };
  ...
  return (
    <div className="eq-admin" style={{ padding: '10px 16px', minHeight: '100%' }}>
      ...
      <div className="a-titlestrip" style={{ padding: '12px 22px' }}>
        <div>
          <div className="a-eyebrow">Lab Assistant · Settings</div>
          <h1>Settings</h1>
        ...
        <div className="a-right">
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, border: '1px solid var(--a-rule)', padding: '10px 16px', background: 'var(--a-surface)' }}>
            ...
            <div>
              <div style={{ fontFamily: 'var(--serif)', fontWeight: 600, fontSize: 14, color: 'var(--a-ink)' }}>{user?.name || 'Lab Assistant'}</div>
              ...
              <div style={{ border: '1px solid var(--a-rule)', background: '#fff' }}>
                ...
                <div style={{ borderTop: '1px solid var(--a-rule)', padding: '8px 10px', display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <div style={{ minWidth: 0 }}>
                    <div style={{ fontFamily: 'var(--sans)', fontSize: 10, fontWeight: 600, color: 'var(--a-navy)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{user?.name || 'Lab Assistant'}</div>
                    <div style={{ fontFamily: 'var(--mono)', fontSize: 8, letterSpacing: '0.1em', color: 'var(--a-mute)' }}>LAB ASSISTANT</div>
                  </div>
                </div>
              </div>

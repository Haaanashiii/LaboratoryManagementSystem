...
import {
  Package, CheckCircle, XCircle, Loader2, Search, CheckSquare,
    ...
    onSuccess: (_, variables) => {
      ...
      if (variables.action === 'approve') {
        Swal.fire({
          ...
          text: 'The borrow request has been forwarded to the Head of Lab for final approval.',
  ...
  return (
    <div className="w-full space-y-4 px-2 py-2">
      ...
      <EquimonPageHeader
        ...
        badge="pending"
        sub="Review and forward borrow requests from your students — or send them back with feedback."
      />
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-slate-200/70 bg-white px-4 py-3 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm font-semibold text-slate-800">Awaiting your review</p>
              ...
              >
                ...
                <div className="flex flex-col items-stretch gap-1.5 w-40 flex-shrink-0 self-start">
                  ...
                  <div className="flex justify-end mb-0.5">
                    <span className="inline-flex items-center gap-1 text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-600 border border-blue-200">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 h-7 rounded-lg text-[11px] text-slate-400 hover:text-slate-600 transition-colors"
                  >
        ...
        <DialogContent className="sm:max-w-[620px] rounded-2xl bg-white text-slate-900 overflow-hidden p-0 gap-0 max-h-[88vh] flex flex-col">
              ...
              <div className="relative h-32 w-full overflow-hidden flex-shrink-0 bg-slate-800">
                ...
                <div className="absolute bottom-0 left-0 right-0 px-6 pb-5 pt-8">
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    <span className="inline-flex items-center rounded-full bg-amber-400/90 px-2 py-0.5 text-[10px] font-semibold text-amber-900">
                      Pending Review
                    </span>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-4 gap-2 border-t border-slate-100 bg-slate-50/50 px-5 py-3">
            ...
            <Button size="sm"
              ...
              <ThumbsUp className="h-3 w-3 mr-1.5" />{t('verify')}
            </Button>
          </div>
        </DialogContent>
      </Dialog>
        ...
        <DialogContent className="sm:max-w-md rounded-2xl bg-white text-slate-900">
          ...
          <div className="py-4 space-y-4">
            <p className="text-sm text-slate-500 leading-relaxed">
              {action === 'approve'
                ? <>Forward <span className="font-medium text-slate-700">{selectedRequest?.borrower_name}</span>'s request for <span className="font-medium text-slate-700">{selectedRequest?.equipment_name}</span> to the Head of Lab.</>
          ...
          <DialogFooter className="gap-2 border-t border-slate-100 pt-4">
            ...
            <Button
              ...
              {actionMutation.isPending
                ...
                : action === 'approve' ? t('Verify and Forward') : t('Reject Request')}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>

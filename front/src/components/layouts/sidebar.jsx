...
import {
  ...
  Pencil, ChevronDown, Printer, Activity, AlertTriangle,
} from 'lucide-react';
...
const GOLD        = '#3b82f6';
const GOLD_3      = '#bfdbfe';
const RULE        = 'rgba(59,130,246,0.22)';
  ...
  lab_assistant: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'problemReturns', icon: AlertTriangle, href: '/problem-returns' },
  ...
  return (
    <>
      ...
      >
        ...
        >
          {collapsed ? (
            <div className="flex h-8 w-8 shrink-0 items-center justify-center" title="ITS">
              <img src={itsLogo} alt="ITS" className="h-full w-full object-contain" style={{ filter: 'brightness(0) invert(1)', opacity: 0.9 }} />
            </div>
          ) : (
            <>
              <div className="flex min-w-0 flex-1 items-center gap-3">
                <img src={itsLogo} alt="ITS" style={{ height: 36, width: 'auto', objectFit: 'contain', flexShrink: 0, filter: 'brightness(0) invert(1)', opacity: 0.9 }} />
                <div className="min-w-0">
                  <span className="block truncate text-[15px] font-bold leading-tight" style={{ color: '#ffffff', fontFamily: "'Source Serif 4', Georgia, serif" }}>
                    ITS
                  </span>
          ...
          {collapsed ? (
            <div className="flex flex-col items-center gap-2">
              <div
                ...
                style={{ background: 'rgba(59,130,246,0.18)', color: GOLD_3, border: `1px solid ${RULE}` }}
            ...
            <>
              ...
              >
                <div
                  ...
                  style={{ background: 'rgba(59,130,246,0.2)', color: GOLD_3, border: `1px solid rgba(59,130,246,0.35)` }}
                >
                  {initials}
                </div>
                <div className="min-w-0 flex-1">
                  ...
                  <p className="truncate text-[9px] leading-tight mt-0.5" style={{ color: '#4a6a8a', fontFamily: "'IBM Plex Mono', monospace", letterSpacing: '0.08em' }}>
                    Equimon
                  </p>
                </div>
              </div>

...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    const hexHoriz = squareSize * Math.sqrt(3)
    const hexVert = squareSize * 1.5
    ...
    const drawGrid = () => {
      ...
      gradient.addColorStop(0.6, 'rgba(10, 10, 15, 0.4)')
    ...
    const wrapX = squareSize * 200
    const wrapY = squareSize * 200

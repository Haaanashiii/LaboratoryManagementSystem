...
export default function AddEquipmentSkeleton() {
  return (
    <div className="mx-auto max-w-3xl w-full space-y-4 px-4 py-6">
      ...
      <SectionSkeleton titleWidth="w-20" descWidth="w-48">
        <div className="grid grid-cols-4 gap-3">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => <CategoryChipSkeleton key={i} />)}
        </div>
      </SectionSkeleton>
      ...
      <SectionSkeleton titleWidth="w-16" descWidth="w-52">
        <Shimmer className="h-32 w-full rounded-2xl border-2 border-dashed border-slate-200" />

...
export default function LecturerPendingApprovalSkeleton() {
  return (
    <div className="w-full space-y-4 px-2 py-2">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm">
        <div className="flex items-center gap-4">
          <Shimmer className="h-12 w-12 rounded-xl flex-shrink-0 bg-amber-100" />
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        <table className="w-full">
          <thead className="bg-slate-50 border-b border-slate-100">
            <tr>
              {['#', 'Equipment', 'Qty', 'Status', 'Submitted', 'Action'].map((h, i) => (
